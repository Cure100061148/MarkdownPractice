...
Note that in GitHub Flavored Markdown, you can also use a special syntax for code(Don't need to indent the text first.)

```javascript
```javascript  (write javascript code inside)```
function() {
